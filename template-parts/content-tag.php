<article id="post-<?php the_ID(); ?>" <?php post_class('tag-page'); ?>> <!-- Tutaj dodałem klasę Home Page ... Tak też możecie wcielać własne klasy -->
    <h2>
  ...
  <p class="lead"> Kategorie: <?php the_category( ', ' ); ?> | <?php the_tags(); ?></p>
